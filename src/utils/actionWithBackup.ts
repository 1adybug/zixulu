...
export function actionWithBackup<T extends (...args: any[]) => Promise<string>>(
    action: T,
    message?: string,
): (...args: Parameters<T>) => Promise<void>
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function actionWithBackup<T extends (...args: any[]) => Promise<void>>(
    action: T,
    message: string,
): (...args: Parameters<T>) => Promise<void>
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function actionWithBackup(
    action: (...args: any[]) => Promise<string | void>,
    message?: string,
) {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return async (...args: any[]) => {
        ...
        if (!(await isRepository()) || skip || !(await hasChangeNoCommit()))
            return
